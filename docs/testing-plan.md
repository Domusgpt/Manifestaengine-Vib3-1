...
- **Phase 5 (Quality/Ops)**: keep observation/replay CLIs covered by unit tests and extend to end-to-end pnpm/Flutter/OpenXR once manifests land.
- **Phase 6 (Effects/Performance)**: retain deterministic effect frame tests here; add WASM parity and performance harnesses when build runners are back.
