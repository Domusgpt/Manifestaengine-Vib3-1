...
- Phase 0–2 artifacts (schemas, Signal Bus journal/replay, SDK-backed render/holographic intents, WASM/CPU goldens) treated as stable prerequisites for agent orchestration.
