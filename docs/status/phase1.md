...
- A Phase 1/2 normalization pipeline lives in-repo to compute derived metrics from the minimal parameter set and attach HOLO alignment metadata for regression harnesses while SDK manifests remain blocked.
