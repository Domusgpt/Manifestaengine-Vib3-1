...
- **Status**: In progress. Effect engine, volumetric slice helpers, and a telemetry performance monitor now output deterministic tiles and latency/jitter aggregates from minimal parameters. pnpm/Flutter/OpenXR harnesses remain blocked until manifests return.
