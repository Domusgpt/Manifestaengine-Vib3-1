...
- **Status**: In progress. Bridge router with derived metrics and capability overlays is implemented; transport adapters, replay
  fixtures, and capability discovery overlays are next.
